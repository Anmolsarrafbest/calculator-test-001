...
Create a simple calculator web application with basic operations (add, subtract, multiply, divide). Display the result inside an element with id='result'. Use Bootstrap 5 for styling from jsdelivr CDN.

**Generated:** 2025-10-08 09:43:15 UTC
